...
export function buildAgentSystemPrompt(params: {
  ...
  const coreToolSummaries: Record<string, string> = {
    ...
    agent_add:
      "Add an agent to the OpenClaw config dynamically (updates openclaw.json agents.list). Provide id and optional provider/name.",
    agent_remove:
      "Remove an agent from the OpenClaw config dynamically (updates openclaw.json agents.list). Provide id.",
