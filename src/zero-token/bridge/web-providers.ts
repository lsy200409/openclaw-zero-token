...
export async function discoverDeepseekWebModels(params?: {
  ...
  return [
    ...
    {
      id: "deepseek-chat-nothinking",
      name: "DeepSeek V3 Fast (Web)",
      reasoning: false,
      input: ["text"],
      cost: DEEPSEEK_WEB_DEFAULT_COST,
      contextWindow: DEEPSEEK_WEB_DEFAULT_CONTEXT_WINDOW,
    ...
    {
      id: "deepseek-pro-nothinking",
      name: "DeepSeek Pro Fast (Web) 专家模式",
      reasoning: false,
      input: ["text"],
      cost: DEEPSEEK_WEB_DEFAULT_COST,
      contextWindow: DEEPSEEK_WEB_DEFAULT_CONTEXT_WINDOW,
    ...
    {
      id: "deepseek-pro-search",
      name: "DeepSeek Pro (Web + Search) 专家模式",
      reasoning: true,
      input: ["text"],
      cost: DEEPSEEK_WEB_DEFAULT_COST,
      contextWindow: DEEPSEEK_WEB_DEFAULT_CONTEXT_WINDOW,
